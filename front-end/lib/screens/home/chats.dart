...
class Chats extends StatelessWidget {
  ...
  var _chatsArr = [
    ...
    { 'name': 'Ronaldo', 'last_message': 'Jissie Flutter is cool', 'last_message_time': '10:42', 'unread': 0 },
    { 'name': 'Bill Gates', 'last_message': 'I\'d like to buy your app.', 'last_message_time': '13:14', 'unread': 1 },
    { 'name': 'Big Data Dave', 'last_message': 'bitcoin'*100, 'last_message_time': '19:20', 'unread': 0},
    { 'name': 'Barack Obama', 'last_message': 'Nice dick bro', 'last_message_time': '09:24', 'unread': 0},
  ];
  ...
  Widget build(BuildContext context) {
    ...
    _chatsArr.sort((a, b) => b['last_message_time'].toString().compareTo(a['last_message_time'].toString()));
