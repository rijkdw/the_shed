...
class Chats extends StatelessWidget {
  ...
  Widget _buildRow(context, messageDict) {
    ...
    return GestureDetector(
        ...
        onTap: () {
          final snackBar =
              SnackBar(content: Text('Chat \"' + _username + '\" selected.'));
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            color: _unread
                ...
                : Color.fromRGBO(
                    0, 0, 0, 0.0), // to allow tapping anywhere on the chat name
          ),
          child: Row(
            children: [
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Text(_username,
                              style:
                                  _unread ? _senderUnreadFont : _senderReadFont,
                              // if the message is unread, use bold font
                              textAlign: TextAlign.left),
                        ),
                        // build message
                        Text(_message_text,
                            overflow: TextOverflow.ellipsis,
                            // fade the text out if it's longer than the row allows
                            maxLines: 1,
                            softWrap: false,
                            style:
                                _unread ? _messageUnreadFont : _messageReadFont,
                            // if the message is unread, use bold font
                            textAlign: TextAlign.left)
                      ]),
                ),
